...
def read_lexicon():
    lexicon_file = os.path.join("..", "lexicons", "wordnet_lexicon_v1.txt")
...
@Language.factory("asent_wordnet_v1")
def create_wordnet_sentiment_component(nlp: Language, name: str) -> Language:
    """
